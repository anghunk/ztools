  ...
  <div>
    ...
    <div>
      <div class="flex" style="margin-bottom: 15px;">
        <el-button type="primary" v-if="iconList.length > 0" @click="copyType = copyType === 'value' ? 'name' : 'value'">复制 {{ copyType }}</el-button>
      ...
      <section v-else>
        <p>点击模块即可复制对应数据。</p>
        <div class="list">
          <div class="item" v-for="(item, index) in iconList" :key="index" @click="copyToClipboard(item[copyType])">
